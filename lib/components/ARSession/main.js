...
import { InjectCSS, browserHasImmersiveArCompatibility, displayUnsupportedBrowserMessage, } from "./utils/domUtils";
...
class ARSession {
    ...
    static async stop(destinationFeatureId) {
...
ARSession.onStopListeners = [];
ARSession.onStartListeners = [];
export { ARSession };
