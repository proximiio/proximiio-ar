...
const gotStream = async (media) => {
    ...
    // Load a texture
    textureLoader.load(new URL('../../../../assets/ad.jpg', import.meta.url).href, (texture) => {
    ...
    // Load a font
    fontLoader.load(new URL('../../../../assets/helvetiker_regular.typeface.json', import.meta.url).href, function (font) {
